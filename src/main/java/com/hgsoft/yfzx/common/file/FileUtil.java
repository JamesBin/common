package com.hgsoft.yfzx.common.file;
...
import com.hgsoft.yfzx.common.exception.BusinessException;
import org.apache.log4j.Logger;

/**
 * 功能描述：文件或文件夹的删除，创建，写入，剪切，解压缩，获取文件大小、文件保存，列表，复制等；
 *
 * @author niehai
...
public class FileUtil {
    ...
    /**
     * 功能描述：从String中创建文件，如果此文件存在覆盖掉，如果不存在创建此文件。
     *
     * @param filePath
     * @param fileData
     * @return 写文件是否成功.
    ...
    /**
     * 功能描述：将byte[]的数据写入文件，如果此文件存在覆盖掉，如果不存在创建此文件。
     *
    ...
    /**
     * 功能描述：从String中创建文件，如果此文件存在覆盖掉，如果不存在创建此文件,如果文件路径上的目录没有则创建此目录。
     *
     * @param filePath
     * @param fileData
     * @return 写文件是否成功.
    ...
    /**
     * 功能描述：将byte[]的数据写入文件，如果此文件存在则覆盖掉，如果不存在创建此文件,目录不存在也直接创建其目录。
     *
     * @param filePath 文件全路径.
     * @param fileData 文件数据.
     * @return 写文件是否成功.
    ...
    /**
     * 功能描述：将指定的文件解压缩到指定的文件夹，解压后的文件夹目录和给定的压缩文件名相同.
     *
    ...
    /**
     * 功能描述：将给定的文件cut到指定的全路径，如果该路径不存在自动创建该路径。
     *
     * @param filePath    全路径。
     * @param toDirectory 全路径。
     * @return 是否成功 成功==true.
     */
    ...
    /**
     * 功能描述：将指定的文件夹cut到指定的路径下，如果该路径不存在，将窜关键该路径。
     *
     * @param directory   全路径
     * @param toDirectory 全路径
     * @return 是否成功 成功==true.
    ...
    /**
     * 功能描述：将指定的文件copy到指定的路径下，如果该路径不存在将创建此路径。
     *
     * @param filePath        全路径
     * @param toDirectoryPath 全路径
     * @return 是否成功 成功==true.
     */
     ...
     * 功能描述：将指定的文件copy到指定的路径下，如果该路径不存在将创建此路径。
     *
     * @param sfilePath 源全路径
     * @param dfilePath 目标全路径
     * @return
     */
    ...
    /**
     * 功能描述：将指定的文件夹copy到指定的路径下，如果指定的制定的路径不存在，创建此路径;指定的路径存在将覆盖.
     *
    ...
    /**
     * 功能描述：不区别文件和文件夹地获取其大小.
     *
     * @param path 文件或者文件夹的大小.
    ...
    /**
     * 功能描述：递归的获取文件夹的每一个文件的大小,并计算总的大小.
     *
     * @param directoryPath 文件夹大小.
     * @param size          递归参数
     ...
     * 功能描述：I帧转图片
     *
     * @param mpgFilePath     MPG的文件路径 如：d:/test/s22.MPG
     * @param targetFilePath  生成的jpg文件路径，存放文件的文件夹必须存在 如：d:/abc/t22.jpg，d:/abc必须存在
     * @param processerFolder 文件夹，里面有处理文件转换用到的dll 文件,exe文件 如：d:/abc/mpg2jpg (在windows下会用到)
     * @return
     * @author lixiang
     ...
     * @param mpgFilePath     MPG的文件路径 如：d:/test/s22.MPG
     * @param targetFilePath  生成的jpg文件路径，存放文件的文件夹必须存在 如：d:/abc/t22.jpg，d:/abc必须存在
     * @param processerFolder 处理文件转换用到的dll 文件,exe文件
     * @return
     * @author lixiang
     * @create 2008-12-17 下午05:54:14
     */
     ...
     *
     * @param sourceStr
     * @param lineType  true : 全转换为"\"; false 全转换为"/"
     * @return
     */
     ...
     * @throws java.io.IOException
     */
    public static void saveFile(InputStream stream,String outpath) throws IOException {
        ...
        try {
            ...
            throw new BusinessException("保存文件是出错");
        }finally {
            if(fs != null){
                fs.close();
            }
     ...
     * @return 文件输入流
     */
    public static FileInputStream stringToInputStream(String dataPath) throws FileNotFoundException {
