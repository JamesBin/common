package com.hgsoft.yfzx.common.zip;
...
/**
 * 功能描述：java.util.zip解压缩操作
 *
 * @author leigq
 * @version 1.0.0
 * @2010-11-12 下午02:09:27
 */
public class ZipUtilOfJava {
    private static final int BUFFER = 2048;

    private final static Logger logger = Logger.getLogger(ZipUtilOfJava.class);
