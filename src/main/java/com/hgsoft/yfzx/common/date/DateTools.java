...
/**
 * 功能描述：日期常用工具方法类，获得当前时间返回字符串（各种格式），两个日期间隔天数的计算（可选择是否包含非工作日）等；
 */
public final class DateTools {
    ...
    /**
     * 功能描述：计算两个日期之间的时间间隔(d1-d2)，可选择是否计算工作日
     *
     * @param d1
     * @param d2
    ...
    /**
     * 功能描述：计算两个时间之间的间隔  单位：分钟(minutes)
     ...
     * 功能描述：两个时间段得相交的天数
     *
     * @param b1 格式yyyy-MM-dd
     * @param e1 格式yyyy-MM-dd
     * @param b2 格式yyyy-MM-dd
     * @param e2 格式yyyy-MM-dd
     * @return
     */
